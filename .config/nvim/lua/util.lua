...
--- https://github.com/neovim/nvim-  issues/3818#issuecomment-2848836794
---
...
-- Maps   style command options to nvim_create_user_command (i.e. |command-attributes|) option names.
local opts_aliases = {
  ['description'] = 'desc',
}
