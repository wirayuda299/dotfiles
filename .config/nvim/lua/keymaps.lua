...
map("n", "<S-Right>", "<cmd>bnext<cr>", { silent = true })
map("n", "<S-Left>", "<cmd>bprevious<cr>", { silent = true })
map("n", "<leader>x", "<cmd>bdelete<cr>", { silent = true })
map("n", "<leader>e", "<cmd>ExplorerFocus<cr>", { silent = true })
map("n", "<C-n>", "<cmd>ExplorerToggle<cr>", { silent = true })
